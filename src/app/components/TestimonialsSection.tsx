...
const testimonials = [
  {
    ...
    content: "Best Nexus Stream service I've ever used! The 4K streams are crystal clear and I never experience buffering during live games. The sports channels cover everything from NFL to soccer.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Best Arabic Nexus Stream provider! All the major MBC channels, beIN Sports, and Arabic movies in HD quality. Customer support helped me set up on my Firestick quickly.",
    rating: 5,
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80",
  ...
  role: "Football Fan",
  content: "I mainly use Nexus Stream for live football and it has been flawless. No lag, no buffering, and all major leagues are available in HD and 4K quality.",
  rating: 5,
  avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80",
